...
export const menuSections: MenuSection[] = [
  {
    ...
    "items": [
      ...
      },
      {
        "name": "Breeze",
        "price": 280,
        "description": "A tropical fusion of cranberry and pineapple with a hint of vanilla and soda, finished with a fresh pineapple slice."
      },
      {
        "name": "Daydream",
        "price": 300,
        "description": "A sun-kissed blend of orange, pineapple, and passion fruit with a splash of lemon and sparkling soda, finished with a fresh orange slice."
      },
      {
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "name": "9:50 Signature Coffee Cheese Cake",
        "price": 280,
        "isSignature": true
      },
      {
